...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    try {
        $insertQuery = "INSERT INTO users (username, email, password, role) 
                       VALUES (:username, :email, :password, 'scholarship_officer')";
        ...
        $errorMessage = "Error creating employee account: " . $e->getMessage();
    }
}
?>
<!DOCTYPE html>
  ...
  <main class="main">
    ...
    <div class="page-title light-background">
      <div class="container d-lg-flex justify-content-between align-items-center">
        <h1 class="mb-2 mb-lg-0">Create Employee Account</h1>
        <nav class="breadcrumbs">
          <ol>
            <li><a href="index.php">Home</a></li>
            <li class="current">Create Employee</li>
          </ol>
        </nav>
      </div>
    </div><!-- End Page Title -->
    ...
    <section id="create" class="assignment section">
      <div class="container" data-aos="fade-up" data-aos-delay="100">
        ...
        <form method="POST" action="create-employee.php">
          <div class="row">
            <div class="col-lg-8 offset-lg-2">
              <div class="duty-details">
                <h3 class="section-title">Employee Account Information</h3>
                ...
                <div class="d-grid gap-2 mt-4">
                  <button type="submit" class="btn btn-primary btn-lg" id="createEmployeeBtn">Create Employee Account</button>
                </div>
              </div>
            </div>
          </div>
