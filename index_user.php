...
<nav id="navmenu" class="navmenu">
  <ul>
    <li><a href="index_user.php" class="active">Home</a></li>

    <?php if (hasAccess($userRole, 'dashboard')): ?>
    ...
    ?>
    <li class="dropdown">
      <a href="#" class="toggle-dropdown">Duty Options</a>
    ...
    ?>
    <li class="dropdown">
      <a href="#" class="toggle-dropdown">Create Accounts</a>
      <ul class="dropdown-menu">
        ...
        <div class="row align-items-center">
          <div class="col-lg-12 text-center">
            <div class="hero-content" data-aos="fade-up" data-aos-delay="200">
              ...
              <p>Role-based access to the comprehensive digital platform for managing, tracking, and evaluating student duties across all departments at PHINMA COC. Enhancing accountability, streamlining workflows, and promoting student engagement in Cagayan de Oro City.</p>
        ...
        <div class="row align-items-center g-5">
          <div class="col-lg-12">
            <div class="about-content text-center" data-aos="fade-up" data-aos-delay="200">
              ...
              <p class="lead">Welcome to your role-specific dashboard. The Student Duty Log system at PHINMA Cagayan de Oro College revolutionizes how our institution manages student responsibilities, tracks academic progress, and fosters accountability through innovative digital solutions tailored for Filipino students.</p>

              <?php if ($userRole === 'student'): ?>
              <p>As a student, you can log your duty hours, view your assigned duties, and track your progress towards completing your academic requirements.</p>
              <?php elseif ($userRole === 'instructor'): ?>
              <p>As an instructor, you can approve duty entries, monitor student progress, and evaluate student performance in their assigned duties.</p>
              <?php elseif ($userRole === 'scholarship_officer'): ?>
              <p>As a scholarship officer, you have comprehensive access to assign duties, approve entries, monitor progress, and evaluate student performance across all departments.</p>
              <?php endif; ?>
