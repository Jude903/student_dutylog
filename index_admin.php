...
if (!isset($_SESSION['role']) || $_SESSION['role'] !== 'superadmin') {
    // Redirect to user index if not admin
...
<head>
  ...
  <meta name="description" content="PHINMA Cagayan de Oro College Student Duty Log Management System - Admin Panel">
  <meta name="keywords" content="PHINMA COC, student duty, duty log, college management, Cagayan de Oro, admin">
        ...
        <div class="row align-items-center">
          <div class="col-lg-12 text-center">
            <div class="hero-content" data-aos="fade-up" data-aos-delay="200">
              ...
              <p>Complete administrative control over the Student Duty Log system. Manage all aspects of duty assignments, approvals, monitoring, and evaluations across all departments at PHINMA COC.</p>
        ...
        <div class="row align-items-center g-5">
          <div class="col-lg-12">
            <div class="about-content text-center" data-aos="fade-up" data-aos-delay="200">
              ...
              <p class="lead">As a system administrator, you have complete access to all features and functions of the Student Duty Log Management System at PHINMA Cagayan de Oro College.</p>
              <p>Manage duty assignments, oversee approvals, monitor student progress, evaluate performance, and maintain system integrity across all departments and user roles.</p>
              ...
              <div class="certifications mt-5" data-aos="fade-up" data-aos-delay="700">
                <h5>Administrative Capabilities</h5>
                <p>Duty Assignment • Approval Management • Progress Monitoring • Student Evaluation • System Administration</p>
              </div>
            </div>
          </div>
        </div>
    ...
    <div class="container footer-top">
      <div class="row gy-4">
        <div class="col-lg-5 col-md-12 footer-about">
          <a href="index_admin.php" class="logo d-flex align-items-center">
            <span class="sitename">Student Duty Log - Admin</span>
          </a>
          <p>Complete administrative control over PHINMA Cagayan de Oro College's student duty management system. Full access to all features and comprehensive oversight capabilities.</p>
