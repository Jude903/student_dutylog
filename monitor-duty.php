...
<head>
  ...
  <meta name="description" content="PHINMA Cagayan de Oro College Student Duty Monitoring System">
  <meta name="keywords" content="PHINMA COC, student duty, duty monitoring, college management, Cagayan de Oro">
  ...
  <link href="assets/css/monitor-duty.css" rel="stylesheet">
...
<body class="index-page">
  ...
  <script>
    ...
    function renderMonitorDetails(duty) {
      ...
      const pendingEntries = duty.entries.filter(entry => entry.status === 'pending').length;
      ...
      detailsContainer.innerHTML = `
        ...
        <div class="duty-info mb-4">
          <div class="d-flex justify-content-between align-items-center mb-2">
            <h5 class="mb-0">Monitoring Overview</h5>
          ...
          <div class="row text-center">
            <div class="col-4">
              <div class="p-2 bg-light rounded">
                <h6 class="mb-0">${approvedEntries}</h6>
                <small>Approved</small>
              </div>
            </div>
            <div class="col-4">
              <div class="p-2 bg-light rounded">
                <h6 class="mb-0">${pendingEntries}</h6>
                <small>Pending</small>
              </div>
            </div>
            <div class="col-4">
              <div class="p-2 bg-light rounded">
                <h6 class="mb-0">${rejectedEntries}</h6>
